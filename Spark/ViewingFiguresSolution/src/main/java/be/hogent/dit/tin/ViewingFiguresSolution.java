...
public class ViewingFiguresSolution {
	...
	public static void main(String[] args) {
		 ...
		 * percent berekenen
		 */
		Dataset<Row> percentageDF = viewDF.join(chaptersDF, "chapterId").drop("chapterId").groupBy("userId", "courseId")
				.count().drop("userId").join(chaptersPerCourse, "courseId")
				.withColumn("percentage", col("count").divide(col("chapters"))).drop("chapters","count");
